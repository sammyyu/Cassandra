...
public class BinaryMemtableManager
{
    ...
    private ExecutorService flusher_ = new DebuggableThreadPoolExecutor(16, 16, Integer.MAX_VALUE, TimeUnit.SECONDS, new LinkedBlockingQueue<Runnable>(), new ThreadFactoryImpl("BINARY-MEMTABLE-FLUSHER-POOL"));
